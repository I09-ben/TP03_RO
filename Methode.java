...
public class Methode extends solve{
    private static void recherchefilters;                
    private SolutionPartielle chercherMeilleureSolution separations;                
    private Stack<Node> nodesToExplore;
